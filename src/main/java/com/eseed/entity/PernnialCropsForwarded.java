...
@Entity
@Table
public class PernnialCropsForwarded {
	...
	@GeneratedValue( strategy = GenerationType.AUTO)
		...
		public PernnialCropsForwarded() {
			super();
			// TODO Auto-generated constructor stub
		}
		public PernnialCropsForwarded(String bookingid, String oc_name, String cr_farmeruid, String oc_fname,
				String owner_tenant, String kh_no, String cr_sno, String cropname, String varietyname,
				String cr_mix_unmix_ext, String cr_sow_type, String cropnature, String watersource,
				String irrmethoddesc, String seed_production, String cr_sow_date, String farmingtype, String vname) {
			super();
		...
		public String toString() {
			return "PernnialCropsForwarded [bookingid=" + bookingid + ", oc_name=" + oc_name + ", cr_farmeruid="
					...
					+ ", seed_production=" + seed_production + ", cr_sow_date=" + cr_sow_date + ", farmingtype="
					+ farmingtype + ", vname=" + vname + "]";
		}
