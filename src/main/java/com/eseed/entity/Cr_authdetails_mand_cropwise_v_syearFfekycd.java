...
public class Cr_authdetails_mand_cropwise_v_syearFfekycd {
	 ...
	 private String wbmname;
		...
		public String toString() {
			return "Cr_authdetails_mand_cropwise_v_syearFfekycd [wbdname=" + wbdname + ", wbmname=" + wbmname
					...
					+ vroauthextent + ", totekycbookings=" + totekycbookings + ", totfarmercount=" + totfarmercount
					+ ", ekycfarmercount=" + ekycfarmercount + ", ekycbookedext=" + ekycbookedext + "]";
		}
