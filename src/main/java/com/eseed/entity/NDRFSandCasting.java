...
@Entity
@Table
public class NDRFSandCasting {
	@Id
	@GeneratedValue(strategy=GenerationType.AUTO)
	private String district;
	private Number sfmf_farmers;
	...
	public NDRFSandCasting() {
		super();
		// TODO Auto-generated constructor stub
	}

	public NDRFSandCasting(String district, Number sfmf_farmers, Number sfmf_ext, Number sfmf_rainfed_ipsamt,
	...
	public Number getSfmf_farmers() {
		return sfmf_farmers;
	}

	public void setSfmf_farmers(Number sfmf_farmers) {
		this.sfmf_farmers = sfmf_farmers;
	}
	...
	public String toString() {
		return "NDRFSandCasting [district=" + district + ", sfmf_farmers=" + sfmf_farmers + ", sfmf_ext=" + sfmf_ext
