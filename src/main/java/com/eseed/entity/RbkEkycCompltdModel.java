...
public class RbkEkycCompltdModel {
	...
	public String getDtekyc() {
		return dtekyc;
	}
	public void setDtekyc(String dtekyc) {
		this.dtekyc = dtekyc;
	}
	...
	public RbkEkycCompltdModel(String cr_vcode, String ekycfarmername, String cr_farmeruid, String wbdname,
			String wbmname, String wbvname, String occupname, String bookingid, String kh_no, String dtekyc,
			String updatedby, String cultdesc, String varietyname, String cr_sno, String cr_mix_unmix_ext,
	...
	public RbkEkycCompltdModel() {
		super();
		// TODO Auto-generated constructor stub
	}
	@Override
	public String toString() {
		return "RbkEkycCompltdModel [cr_vcode=" + cr_vcode + ", ekycfarmername=" + ekycfarmername + ", cr_farmeruid="
				+ cr_farmeruid + ", wbdname=" + wbdname + ", wbmname=" + wbmname + ", wbvname=" + wbvname
				+ ", occupname=" + occupname + ", bookingid=" + bookingid + ", kh_no=" + kh_no + ", dtekyc=" + dtekyc
				+ ", updatedby=" + updatedby + ", cultdesc=" + cultdesc + ", varietyname=" + varietyname + ", cr_sno="
				+ cr_sno + ", cr_mix_unmix_ext=" + cr_mix_unmix_ext + ", cr_crop=" + cr_crop + ", ekyc=" + ekyc
				+ ", cropname=" + cropname + ", cropduration=" + cropduration + ", vaaauth=" + vaaauth + "]";
	}
