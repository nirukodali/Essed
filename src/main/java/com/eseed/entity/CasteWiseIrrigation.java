...
@Entity
@Table
public class CasteWiseIrrigation {
	@Id
	...
	public CasteWiseIrrigation() {
		super();
		// TODO Auto-generated constructor stub
	}


	public CasteWiseIrrigation(String wbdname, String wbmname, String wbvname, String caste,
	...
	public String toString() {
		return "CasteWiseIrrigation [wbdname=" + wbdname + ", wbmname=" + wbmname + ", wbvname=" + wbvname + ", caste="
				+ caste + ", sc_conventional_farmers=" + sc_conventional_farmers + ", sc_conventional_ext="
