...
public class Rep_vaa_draft_listModel {
...
public String toString() {
	return "Rep_vaa_draft_listModel [cr_no=" + cr_no + ", cultdesc_loclang=" + cultdesc_loclang + ", cultdesc="
			+ cultdesc + ", ftype_short=" + ftype_short + ", varietyname=" + varietyname + ", occupname=" + occupname
			+ ", occupfname=" + occupfname + ", sdate=" + sdate + ", cr_dist_code=" + cr_dist_code + ", cr_mand_code="
			+ cr_mand_code + ", cr_vcode=" + cr_vcode + ", wbdname=" + wbdname + ", wbmname=" + wbmname + ", wbvname="
			+ wbvname + ", kh_no=" + kh_no + ", bookingid=" + bookingid + ", vaaauth=" + vaaauth + ", vroauth="
			+ vroauth + ", ekyc=" + ekyc + ", naturedesc=" + naturedesc + ", mao_unlock_appr=" + mao_unlock_appr
			+ ", sclength=" + sclength + ", cr_farmeruid=" + cr_farmeruid + ", cr_sno=" + cr_sno + ", cr_mix_unmix_ext="
			+ cr_mix_unmix_ext + ", cr_crop=" + cr_crop + ", cropins=" + cropins + ", cropname=" + cropname
			+ ", wsrcdesc=" + wsrcdesc + ", cropduration=" + cropduration + ", ins_scheme=" + ins_scheme
			+ ", smsmobileno=" + smsmobileno + ", supercheck_userid=" + supercheck_userid + ", irrmethoddesc="
			+ irrmethoddesc + ", seed_production=" + seed_production + ", getCr_no()=" + getCr_no()
			+ ", getCultdesc_loclang()=" + getCultdesc_loclang() + ", getCultdesc()=" + getCultdesc()
			+ ", getFtype_short()=" + getFtype_short() + ", getVarietyname()=" + getVarietyname() + ", getOccupname()="
			+ getOccupname() + ", getOccupfname()=" + getOccupfname() + ", getSdate()=" + getSdate()
			+ ", getCr_dist_code()=" + getCr_dist_code() + ", getCr_mand_code()=" + getCr_mand_code()
			+ ", getCr_vcode()=" + getCr_vcode() + ", getWbdname()=" + getWbdname() + ", getWbmname()=" + getWbmname()
			+ ", getWbvname()=" + getWbvname() + ", getKh_no()=" + getKh_no() + ", getBookingid()=" + getBookingid()
			+ ", getVaaauth()=" + getVaaauth() + ", getVroauth()=" + getVroauth() + ", getEkyc()=" + getEkyc()
			+ ", getNaturedesc()=" + getNaturedesc() + ", getMao_unlock_appr()=" + getMao_unlock_appr()
			+ ", getSclength()=" + getSclength() + ", getCr_farmeruid()=" + getCr_farmeruid() + ", getCr_sno()="
			+ getCr_sno() + ", getCr_mix_unmix_ext()=" + getCr_mix_unmix_ext() + ", getCr_crop()=" + getCr_crop()
			+ ", getCropins()=" + getCropins() + ", getCropname()=" + getCropname() + ", getWsrcdesc()=" + getWsrcdesc()
			+ ", getCropduration()=" + getCropduration() + ", getIns_scheme()=" + getIns_scheme()
			+ ", getSmsmobileno()=" + getSmsmobileno() + ", getSupercheck_userid()=" + getSupercheck_userid()
			+ ", getIrrmethoddesc()=" + getIrrmethoddesc() + ", getSeed_production()=" + getSeed_production()
