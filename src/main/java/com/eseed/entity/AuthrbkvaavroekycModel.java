...
public class AuthrbkvaavroekycModel {
...
public AuthrbkvaavroekycModel(String vscode, String wbvname, String totfarmercount, String totalbookings,
		String totextent, String vaaauthcount, String vaaauthextent, String vroauthcount, String vroauthextent,
		String totekycbookings, String ekycfarmercount, String ekycbookedext) {
	super();
	this.vscode = vscode;
	this.wbvname = wbvname;
	this.totfarmercount = totfarmercount;
...
public AuthrbkvaavroekycModel() {
	super();
	// TODO Auto-generated constructor stub
}
@Override
public String toString() {
	return "AuthrbkvaavroekycModel [vscode=" + vscode + ", wbvname=" + wbvname + ", totfarmercount=" + totfarmercount
			+ ", totalbookings=" + totalbookings + ", totextent=" + totextent + ", vaaauthcount=" + vaaauthcount
			+ ", vaaauthextent=" + vaaauthextent + ", vroauthcount=" + vroauthcount + ", vroauthextent=" + vroauthextent
