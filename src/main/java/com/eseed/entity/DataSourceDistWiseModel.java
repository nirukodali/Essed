...
public class DataSourceDistWiseModel {
	...
	public DataSourceDistWiseModel() {
		super();
		// TODO Auto-generated constructor stub
	}

	public DataSourceDistWiseModel(String cr_dist_code, String dcode, String dname, String totvillages,
			String efish_cnt, String efishdownloaded, String efishnotdownloaded, String wb_cnt,
			String weblanddownloaded, String weblandnotdownloaded, String ccrc_cnt, String ccrcdownloaded,
			String ccrcnotdownloaded, String rofr_cnt, String rofrdownloaded, String rofrnotdownloaded, String peri_cnt,
	...
	public String toString() {
		return "DataSourceDistWiseModel [cr_dist_code=" + cr_dist_code + ", dcode=" + dcode + ", dname=" + dname
