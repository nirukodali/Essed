...
private String updatedby;
	...
	public String toString() {
		return "Cr_crop_det_new_v_swbdistyear [ekycfarmername=" + ekycfarmername + ", exception_type=" + exception_type
				...
				+ cr_mix_unmix_ext + ", cr_no=" + cr_no + ", superchkwithgeo=" + superchkwithgeo + ", cr_w_draw="
				+ cr_w_draw + ", occupant_extent=" + occupant_extent + ", superchkRemarks=" + superchkRemarks
				+ ", updatedby=" + updatedby + ", farmingtype=" + farmingtype + ", irrmethoddesc=" + irrmethoddesc
				+ ", naturedesceng=" + naturedesceng + "]";
	}
