...
@Entity
@Table
public class CasteWiseIrrigationHQMandal {
	@Id
	...
	public CasteWiseIrrigationHQMandal() {
		super();
		// TODO Auto-generated constructor stub
	}


	public CasteWiseIrrigationHQMandal(String wbdname, String wbmname, Number sc_conventional_farmers_total,
	...
	public String toString() {
		return "CasteWiseIrrigationHQMandal [wbdname=" + wbdname + ", wbmname=" + wbmname
				...
				+ gen_sprinkler_farmers_total + ", gen_sprinkler_ext_total=" + gen_sprinkler_ext_total + ", wbdcode="
				+ wbdcode + ", wbmcode=" + wbmcode + "]";
	}
