...
public class RepRbkekycPendingModel {
...
public RepRbkekycPendingModel() {
	super();
	// TODO Auto-generated constructor stub
}
public RepRbkekycPendingModel(String mobileno, String wbdname, String wbmname, String wbvname, String occupname,
		String cr_farmeruid, String bookingid, String kh_no, String cultdesc, String varietyname, String cr_sno,
		String cr_mix_unmix_ext, String updatedby, String cr_crop, String ekyc, String cropname, String cropduration,
		String vaaauth) {
	super();
	this.mobileno = mobileno;
	this.wbdname = wbdname;
...
public String toString() {
	return "RepRbkekycPendingModel [mobileno=" + mobileno + ", wbdname=" + wbdname + ", wbmname=" + wbmname
			+ ", wbvname=" + wbvname + ", occupname=" + occupname + ", cr_farmeruid=" + cr_farmeruid + ", bookingid="
			+ bookingid + ", kh_no=" + kh_no + ", cultdesc=" + cultdesc + ", varietyname=" + varietyname + ", cr_sno="
			+ cr_sno + ", cr_mix_unmix_ext=" + cr_mix_unmix_ext + ", updatedby=" + updatedby + ", cr_crop=" + cr_crop
			+ ", ekyc=" + ekyc + ", cropname=" + cropname + ", cropduration=" + cropduration + ", vaaauth=" + vaaauth
			+ "]";
}
