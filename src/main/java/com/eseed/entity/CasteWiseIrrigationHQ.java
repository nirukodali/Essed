...
@Entity
@Table
public class CasteWiseIrrigationHQ {
	@Id
	...
	public CasteWiseIrrigationHQ() {
		super();
		// TODO Auto-generated constructor stub
	}


	public CasteWiseIrrigationHQ(String wbdname, Number sc_conventional_farmers_total, Number sc_conventional_ext_total,
	...
	public String toString() {
		return "CasteWiseIrrigationHQ [wbdname=" + wbdname + ", sc_conventional_farmers_total="
				...
				+ ", gen_sprinkler_ext_total=" + gen_sprinkler_ext_total + ", wbdcode=" + wbdcode + "]";
	}
