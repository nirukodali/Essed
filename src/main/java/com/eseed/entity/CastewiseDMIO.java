...
public class CastewiseDMIO {
	...
	public CastewiseDMIO() {
		super();
		// TODO Auto-generated constructor stub
	}


	public CastewiseDMIO(String wbdname, String wbmname, Number sc_conventional_farmers_total,
			Number sc_conventional_ext_total, Number st_conventional_farmers_total, Number st_conventional_ext_total,
	...
	public String toString() {
		return "CastewiseDAO [wbdname=" + wbdname + ", wbmname=" + wbmname + ", sc_conventional_farmers_total="
				+ sc_conventional_farmers_total + ", sc_conventional_ext_total=" + sc_conventional_ext_total
				+ ", st_conventional_farmers_total=" + st_conventional_farmers_total + ", st_conventional_ext_total="
				+ st_conventional_ext_total + ", bc_conventional_farmers_total=" + bc_conventional_farmers_total
				+ ", bc_conventional_ext_total=" + bc_conventional_ext_total + ", gen_conventional_farmers_total="
				+ gen_conventional_farmers_total + ", gen_conventional_ext_total=" + gen_conventional_ext_total
				+ ", sc_dripirr_farmers_total=" + sc_dripirr_farmers_total + ", sc_dripirr_ext_total="
				+ sc_dripirr_ext_total + ", st_dripirr_farmers_total=" + st_dripirr_farmers_total
				+ ", st_dripirr_ext_total=" + st_dripirr_ext_total + ", bc_dripirr_farmers_total="
				+ bc_dripirr_farmers_total + ", bc_dripirr_ext_total=" + bc_dripirr_ext_total
				+ ", gen_dripirr_farmers_total=" + gen_dripirr_farmers_total + ", gen_dripirr_ext_total="
				+ gen_dripirr_ext_total + ", sc_sprinkler_farmers_total=" + sc_sprinkler_farmers_total
				+ ", sc_sprinkler_ext_total=" + sc_sprinkler_ext_total + ", st_sprinkler_farmers_total="
				+ st_sprinkler_farmers_total + ", st_sprinkler_ext_total=" + st_sprinkler_ext_total
				+ ", bc_sprinkler_farmers_total=" + bc_sprinkler_farmers_total + ", bc_sprinkler_ext_total="
				+ bc_sprinkler_ext_total + ", gen_sprinkler_farmers_total=" + gen_sprinkler_farmers_total
				+ ", gen_sprinkler_ext_total=" + gen_sprinkler_ext_total + ", wbdcode=" + wbdcode + ", wbmcode="
				+ wbmcode + "]";
	}
