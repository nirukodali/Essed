...
@Entity
@Table
public class CastewiseDMIOVillage {
	@Id
	...
	public CastewiseDMIOVillage() {
		super();
		// TODO Auto-generated constructor stub
	}

	public CastewiseDMIOVillage(String wbdname, String wbmname, String wbvname, Number sc_conventional_farmers_total,
	...
	public String toString() {
		return "CastewiseDAOVillage [wbdname=" + wbdname + ", wbmname=" + wbmname + ", wbvname=" + wbvname
