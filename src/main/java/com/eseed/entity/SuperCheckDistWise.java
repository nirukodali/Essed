...
public class SuperCheckDistWise {
	...
	public String toString() {
		return "SuperCheckDistWise [dname=" + dname + ", dao_allotted=" + dao_allotted + ", dao_approved="
				+ dao_approved + ", dao_rejected=" + dao_rejected + ", dao_updated=" + dao_updated + ", dho_allotted="
				+ dho_allotted + ", dho_approved=" + dho_approved + ", dho_rejected=" + dho_rejected + ", dho_updated="
				+ dho_updated + ", rdo_allotted=" + rdo_allotted + ", rdo_approved=" + rdo_approved + ", rdo_rejected="
				+ rdo_rejected + ", rdo_updated=" + rdo_updated + ", ada_allotted=" + ada_allotted + ", ada_approved="
				+ ada_approved + ", ada_rejected=" + ada_rejected + ", ada_updated=" + ada_updated + ", tah_allotted="
				+ tah_allotted + ", tah_approved=" + tah_approved + ", tah_rejected=" + tah_rejected + ", tah_updated="
				+ tah_updated + ", mao_allotted=" + mao_allotted + ", mao_approved=" + mao_approved + ", mao_rejected="
				+ mao_rejected + ", mao_updated=" + mao_updated + ", ho_allotted=" + ho_allotted + ", ho_approved="
				+ ho_approved + ", ho_rejected=" + ho_rejected + ", ho_updated=" + ho_updated + ", dc_allotted="
				+ dc_allotted + ", dc_approved=" + dc_approved + ", dc_rejected=" + dc_rejected + ", dc_updated="
				+ dc_updated + ", jc_allotted=" + jc_allotted + ", jc_approved=" + jc_approved + ", jc_rejected="
				+ jc_rejected + ", jc_updated=" + jc_updated + ", hod_allotted=" + hod_allotted + ", hod_approved="
				+ hod_approved + ", hod_rejected=" + hod_rejected + ", hod_updated=" + hod_updated + ", mname=" + mname
				+ ", getDname()=" + getDname() + ", getDao_allotted()=" + getDao_allotted() + ", getDao_approved()="
				+ getDao_approved() + ", getDao_rejected()=" + getDao_rejected() + ", getDao_updated()="
				+ getDao_updated() + ", getDho_allotted()=" + getDho_allotted() + ", getDho_approved()="
				+ getDho_approved() + ", getDho_rejected()=" + getDho_rejected() + ", getDho_updated()="
				+ getDho_updated() + ", getRdo_allotted()=" + getRdo_allotted() + ", getRdo_approved()="
				+ getRdo_approved() + ", getRdo_rejected()=" + getRdo_rejected() + ", getRdo_updated()="
				+ getRdo_updated() + ", getAda_allotted()=" + getAda_allotted() + ", getAda_approved()="
				+ getAda_approved() + ", getAda_rejected()=" + getAda_rejected() + ", getAda_updated()="
				+ getAda_updated() + ", getTah_allotted()=" + getTah_allotted() + ", getTah_approved()="
				+ getTah_approved() + ", getTah_rejected()=" + getTah_rejected() + ", getTah_updated()="
				+ getTah_updated() + ", getMao_allotted()=" + getMao_allotted() + ", getMao_approved()="
				+ getMao_approved() + ", getMao_rejected()=" + getMao_rejected() + ", getMao_updated()="
				+ getMao_updated() + ", getHo_allotted()=" + getHo_allotted() + ", getHo_approved()=" + getHo_approved()
				...
				+ ", getMname()=" + getMname() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
