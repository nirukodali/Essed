...
public class RegularExpressionclassMethod {
    ...
    public boolean wbvcode(String doubleValue) {
    ...
    public Boolean checkForInvalidAadhaar(String number) {
...
//        }
 ...
 if ("123456789012".equals(number) || "012345678901".equals(number) || "111111111111".equals(number)|| "222222222222".equals(number)|| "333333333333".equals(number)|| "444444444444".equals(number)
		 || "555555555555".equals(number)|| "666666666666".equals(number)|| "777777777777".equals(number)|| "888888888888".equals(number)|| "999999999999".equals(number)|| "000000000000".equals(number)) {
            return false;
        }
    	if(!validateVerhoeff(number)) {
    		return false;
    	}
    	else {
    		return true;
